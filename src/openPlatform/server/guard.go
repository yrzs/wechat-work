...
import (
	...
	response2 "github.com/yrzs/wechat-work/src/openPlatform/response"
	openplatform "github.com/yrzs/wechat-work/src/openPlatform/server/callbacks"
	"github.com/yrzs/wechat-work/src/openPlatform/server/handlers"
	"io"
	"io/ioutil"
	"net/http"
)
